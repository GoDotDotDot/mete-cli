...
module.exports = {
  ...
  actions: (data) => {
    ...
    const actions = [
      {
        type: 'add',
        path: path.resolve(process.cwd(), './app/containers/{{properCase name}}/index.js'),
    ...
    if (data.wantActionsAndReducer) {
      ...
      actions.push({
        type: 'add',
        path: path.resolve(process.cwd(), './app/containers/{{properCase name}}/actions.js'),
      ...
      actions.push({
        type: 'add',
        path: path.resolve(process.cwd(), './app/containers/{{properCase name}}/constants.js'),
      ...
      actions.push({
        type: 'add',
        path: path.resolve(process.cwd(), './app/containers/{{properCase name}}/reducer.js'),
    ...
    if (data.wantSaga) {
      actions.push({
        type: 'add',
        path: path.resolve(process.cwd(), './app/containers/{{properCase name}}/saga.js'),
    ...
    if (data.wantLoadable) {
      actions.push({
        type: 'add',
        path: path.resolve(process.cwd(), './app/containers/{{properCase name}}/Loadable.js'),
